  ...
  return (
    <div class="more-info">
      ...
      <div class="more-info__cards">
        ...
        <p>
          Tendemos a pensar que, dado que son plantas que viven sobre todo en
          desiertos, pueden soportar luz intensa y directa. Sin embargo, la
          realidad no es estrictamente así. Si bien los cactus necesitan dosis
          diarias de luz, lo cierto es que hay un buen número de ellos que no
          soportan el sol directo. Algo que nos harán saber amarilleándose o,
          incluso, blanqueándose. Si los cultivamos en interior, lo ideal será
          que los coloquemos cerca de una ventana con orientación Este.
        ...
        <p>
          ...
          lo más importante en cómo cuidar un cactus.Los cactus tienen unas
          necesidades nutricionales específicas y, además, exigen un suelo que
          favorezca la eliminación del agua sobrante de riego. Dos razones
          vitales para su bienestar que obligan, sí o sí, a utilizar un sustrato
          específico para este tipo de plantas.Gracias a él, las raíces del
          cactus estarán hidratadas pero sin correr el riesgo de encharcarse.
        ...
        <p>
          ...
          a la sequía, no podemos desatender su hidratación especialmente en los
          meses de crecimiento. Por eso, desde primavera hasta el final del
          verano tendremos que regar de forma regular. Y aquí llega la pregunta
          de oro: ¿cada cuánto se riega un cactus en época de crecimiento?
          Sencillo: cuando el sustrato, no la capa superficial, esté
          completamente seco. Algo que solo sabremos introduciendo un dedo o un
        ...
        <p>
          ...
          de los cactus sufren ¡y mucho! expuestos a temperaturas inferiores a 8
          grados. Es más: la suma de un sustrato demasiado húmedo y frío es
          sinónimo de la aparición de hongos. Unos malos compañeros que pueden
        ...
        <p>
          ...
          el agua, a su paso, suele llevarse consigo muchos nutrientes que hay
          en el sustrato.Por ello, desde el comienzo de primavera hasta que
          acaba el periodo de desarrollo, es fundamental aplicar una pauta
          regular de fertilizante específico de cactus. No solo le dará a
        ...
        <p>
          ...
          eliminar, más vale prevenir que curar.¿Cómo? Aplicando dos veces al
          año un fungicida de forma preventiva. No solo protegerá a nuestra
        ...
        <p>
          ...
          las ideales, ya que facilitan la evaporación del agua. Una forma
